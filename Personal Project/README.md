...
* **Feature Engineering:** Created new diagnostic columns, including clinical ratios (e.g., **Nucleus-to-Cytoplasm ratio**), **R-G-B Intensity Percentages**, and **Confidence Score Differences**, to provide deeper layers for visualisation.
...
* **Feature Engineering:** Created new diagnostic columns, including **R-G-B Intensity Percentages** and **Confidence Score Differences**, to provide deeper layers for visualisation.


### 2. Demographic Trend Exploration (Tableau)
* Developed an interactive dashboard to visualise abnormality rates across age groups:
    * **Adults:** 3,276 cells
    * **Elderly:** 1,455 cells
    * **Paediatric:** 1,149 cells
...
* **Insight:** Utilised a scatter plot with a trend line to show a strong positive correlation, supported by a negligible average confidence difference of **0.08**.
...
* **EDA:** Utilised `Seaborn` pairplots and heatmaps to identify **Multicollinearity**, informing the choice of regularized models.
* **Modelling:** Compared three classification approaches to identify the most robust solution for binary anomaly detection:
...
* **Demographic Insights:** Data visualisation confirmed that while anomaly rates are consistent across sexes, specific cell types such as **Blast Cells** and **Schistocytes** are 100% indicative of an anormal classification regardless of patient age group (Paediatric, Adult, or Elderly).
